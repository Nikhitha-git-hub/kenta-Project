...
const OperationalView = () => {
  ...
  return (
    <div className="oview-container" onMouseMove={handleMouseMove} ref={containerRef}>
        ...
        <div className="dashboard-content-main">
          <div className="left-panel-container">
            <div className="description-card lightning-border">
              <div className="inner-card-content" style={{ justifyContent: 'center', height: '100%', margin: 'auto' }}>
                <h3 className="section-title" style={{ fontSize: '2.2rem', textAlign: 'center', lineHeight: '1.4' }}>OPERATIONAL<br />VIEW</h3>
              </div>
            </div>
          </div>
