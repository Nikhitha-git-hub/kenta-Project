...
const ZonalSubsLedger = () => {
  ...
  return (
    <div className="ledger-container" onMouseMove={handleMouseMove} ref={containerRef}>
      ...
      <div className="ledger-outer-container lightning-border" style={{ position: 'relative', maxWidth: '1200px' }}>
        ...
        <div className="ledger-content-main">
          <div className="left-panel-container">
            <div className="description-card lightning-border">
              <div className="inner-card-content" >
                <h3 className="section-title" >ZONAL<br />SUBSIDIARY<br />LEDGER</h3>
              </div>
            </div>
          </div>
          ...
          <div className="right-panel-container">
            <div className="action-buttons-grid">
              ...
              <button className="actionButton">
                <span>Zonal Asset Ledger</span>
              </button>
              <button className="actionButton">
                <span>Bank Account Ledger</span>
              </button>
              <button className="actionButton">
                <span>Franchise Ledger</span>
              </button>
              <button className="actionButton">
