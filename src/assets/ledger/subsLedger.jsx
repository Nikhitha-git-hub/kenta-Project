        ...
        <div className="ledger-content-main">
          <div className="left-panel-container">
            <div className="description-card lightning-border">
              <div className="inner-card-content" >
                <h3 className="section-title" >SUBSIDIARY<br />LEDGER</h3>
              </div>
            </div>
          </div>
          ...
          <div className="right-panel-container">
            <div className="action-buttons-list">
              <Link to="/zonalSubsLedgers" className="full-width-link">
                <button className="actionButton">
                  <span>Zonal Subsidiary</span>
                </button>
              </Link>
              <Link to="/seriesSubsledgers" className="full-width-link">
                <button className="actionButton">
                  <span>Series Subsidiary</span>
                </button>
              </Link>
            </div>
          </div>
