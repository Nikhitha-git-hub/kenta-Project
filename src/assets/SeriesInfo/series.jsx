...
const SeriesInfo = () => {
  ...
  return (
    <div className="series-container" onMouseMove={handleMouseMove} ref={containerRef}>
      <div className="spotlight-overlay"></div>

      <div className="series-outer-container lightning-border" style={{ position: 'relative' }}>
          ...
          <div className="left-panel-container">
            <div className="description-card lightning-border">
              <div className="inner-card-content" >
                <h3 className="section-title" >SERIES<br />INFO</h3>
              </div>
            </div>
          </div>
          ...
          <div className="right-panel-container">
            <div className="action-buttons-list">
              <button className="actionButton">
                <span>AEROCARE SERIES</span>
              </button>
              <button className="actionButton">
                <span>PERSONAL CARE SERIES</span>
              </button>
              <button className="actionButton">
                <span>HYGIENE CARE SERIES</span>
              </button>
            </div>
          </div>
        </div>
